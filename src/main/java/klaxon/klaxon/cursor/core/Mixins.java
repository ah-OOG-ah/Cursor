 ...
 * Copyright (C) 2023-2025 ah-OOG-ah
...
import static klaxon.klaxon.cursor.Cursor.LOG;
import static klaxon.klaxon.cursor.core.CursorCore.EARLY_LOG;
...
public enum Mixins {
    ...
    public static List<String> getEarlyMixins(Set<String> loadedCoreMods) {
        ...
        EARLY_LOG.info("Not loading the following EARLY mixins: {}", notLoading.toString());
        return mixins;
    }
